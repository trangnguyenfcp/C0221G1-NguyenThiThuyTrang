                ...
                <c:forEach items='${customers}' var="customer">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/customer?action=edit&id=${customer.customer_id}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" onclick="sendDataToModal('${customer.customer_id}','${customer.customer_name}')" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/customer?action=delete">
                ...
                <div class="modal-body">
                    <input hidden type="text" name="customer_id" id="customerId">
