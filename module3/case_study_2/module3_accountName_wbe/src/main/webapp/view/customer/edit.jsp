    ...
    <div style="width: 400px">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="customer_gender" id="customer_gender"
                       placeholder="0:female, 1:male, 2:other" value="${customer.customer_gender}">
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="customer_id_card" id="customer_id_card"
                       value="${customer.customer_id_card}">
            </div>
            <div class="form-group">
