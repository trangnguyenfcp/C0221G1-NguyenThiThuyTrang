    ...
    <div class="container">
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul class="nav-inner">
                ...
                <li><a href="/furama?active=employee">Employee</a></li>
                <li><a href="/furama?active=customer">Customer</a></li>
                <li><a href="/furama?active=service">Service</a></li>
                <li><a href="/furama?active=contract">Contract</a></li>
