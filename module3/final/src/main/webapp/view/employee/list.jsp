                ...
                <c:forEach items='${employees}' var="employee" varStatus="theCount">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" onclick="sendDataToModal('${employee.employeeId}','${employee.employeeName}')" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
