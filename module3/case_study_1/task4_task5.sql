...
select C.customer_id, C.customer_name, CT.customer_type_name, Con.contract_id, S.service_name, Con.contract_start_date, Con.contract_end_date, (S.service_cost+ATT.attach_service_cost*CD.quantity) AS total_price
