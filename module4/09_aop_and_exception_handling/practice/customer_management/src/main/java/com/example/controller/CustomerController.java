...
import com.example.exception.DuplicateEmailExceptionExtendsException;
...
public class CustomerController {
    ...
    public ModelAndView showEditForm(@PathVariable Long id) throws CustomerException {
    ...
    public ModelAndView updateCustomer(@ModelAttribute("customer") Customer customer) throws DuplicateEmailExceptionExtendsException {
        customerService.save(customer);
        ModelAndView modelAndView = new ModelAndView("/customer/edit");
        modelAndView.addObject("customer", customer);
