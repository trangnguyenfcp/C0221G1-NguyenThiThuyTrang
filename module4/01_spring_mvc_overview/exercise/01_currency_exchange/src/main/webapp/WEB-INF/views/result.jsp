                ...
                <div class="form-group">
                    ...
                    <select name="from" id="from" class="form-control">
                        <c:forEach items="${currencies}" var="currency">
                            <option value="${currency.value}" ${currency.value==from?"selected":""}>${currency.key}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="to" id="to" class="form-control">
                        <c:forEach items="${currencies}" var="currency">
                            <option value="${currency.value}" ${currency.value==to?"selected":""}>${currency.key}</option>
                        </c:forEach>
                    </select>
                </div>
